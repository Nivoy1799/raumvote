        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "radial-gradient(ellipse at 50% 30%, rgba(96,165,250,0.12) 0%, transparent 60%), radial-gradient(ellipse at 50% 80%, rgba(139,92,246,0.08) 0%, transparent 50%)",
              pointerEvents: "none",
          ...
          >
            ...
            {isActive && remaining > 0 && (
              ...
              >
                ...
                />
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: r.fontSize.small, fontWeight: 800, color: "white" }}>Abstimmung läuft</div>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                ...
                <span style={{ fontSize: r.fontSize.body, fontWeight: 800, color: "white" }}>
                  Vertikal &amp; Horizontal
                </span>
              </div>
              <div
                ...
                >
                  {isIOS ? (
                    <>
                      ...
                      >
                        <path
                          d="M12 3v12M12 3l-4 4M12 3l4 4M4 15v4h16v-4"
